...
import { finiteNeutrality } from "./grades";
...
function normalizeAnalysis(
  ...
  return {
    ...
    model: model ?? "grok",
    summary: {
      // 0 is a real score (extreme framing load). Never `Number(x) || 50`.
      neutrality_score: finiteNeutrality(summaryRaw.neutrality_score, 50),
